...
const pTemplate0 = (rowData, { rowIndex }) => <p >{rowData.stuName}</p>
const pTemplate1 = (rowData, { rowIndex }) => <p >{rowData.courseName}</p>
const p_calendarTemplate2 = (rowData, { rowIndex }) => <p >{rowData.DOB}</p>
const pTemplate3 = (rowData, { rowIndex }) => <p >{rowData.contactNo}</p>
...
<Column field="stuName" header="StuName" body={pTemplate0} filter={selectedFilterFields.includes("stuName")} hidden={selectedHideFields?.includes("stuName")}  sortable style={{ minWidth: "8rem" }} />
...
<Column field="DOB" header="DOB" body={p_calendarTemplate2} filter={selectedFilterFields.includes("DOB")} hidden={selectedHideFields?.includes("DOB")}  sortable style={{ minWidth: "8rem" }} />
<Column field="contactNo" header="ContactNo" body={pTemplate3} filter={selectedFilterFields.includes("contactNo")} hidden={selectedHideFields?.includes("contactNo")}  sortable style={{ minWidth: "8rem" }} />
